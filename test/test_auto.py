...
def test_conf_path():    
    """Check if config file exists / if ``AutoHelper.get_conf_path()`` works.
    """
    ah = pf.AutoHelper()
...
def test_auto_installation():
    """Check if the AUTO command @r is available with the env generated by ``AutoHelper.setup_auto_exec_env()``
    """
    ah = pf.AutoHelper()
